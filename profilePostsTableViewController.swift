...
protocol TableViewContentSizeHeight {
    func callForHeightOfTableView(height: CGFloat)
}

class profilePostsTableViewController: PFQueryTableViewController, MyCustomCellDelegator {
    ...
    var heightdelegator:TableViewContentSizeHeight!
    var number1:Int = 0
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        //println(" ye hai \(self.tableView.contentSize.height)")
        //self.preferredContentSize.height = self.tableView.contentSize.height
        //println(self.preferredContentSize.height)
        self.tableView.reloadData()
        print(" When appears \(self.tableView.contentSize.height)")
        //self.preferredContentSize.height = self.tableView.contentSize.height
    }
    override func viewDidLayoutSubviews() {
        ...
        {
            //self.heightdelegator.callForHeightOfTableView(self.tableView.contentSize.height)
            //self.preferredContentSize.height = self.tableView.contentSize.height
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath, object: PFObject?) -> PFTableViewCell? {
        let cell1 = tableView.dequeueReusableCellWithIdentifier("cell1") as! ImagePostCell
